...
# Core Skills
    ...
    • Systems: Windows 10/11, Windows Server, macOS, Linux
    • Identity & Access: Active Directory, Group Policy, user provisioning
    • Networking Fundamentals: DNS, DHCP, VPN, LAN/Wi‑Fi troubleshooting
    • Hardware Support: Workstations, laptops, printers, peripherals
    • Cloud & Tools: Azure, SQL, diagnostic tools, remote support platforms
    • Documentation: Knowledge base articles, ticket notes, SOPs
